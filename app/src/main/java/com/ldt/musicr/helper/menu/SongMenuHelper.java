...
import com.ldt.musicr.ui.dialog.RemoveFromPlaylistDialog;
...
public class SongMenuHelper {
    ...
    public static final int[] PL_SONG_OPTION = new int[]{
            /*   R.string.play,*/
            R.string.divider,
            R.string.play_next,
            R.string.add_to_queue,
            ...
            R.string.set_as_ringtone,
            R.string.share,
            R.string.delete_from_playlist1
    };
...
//                  SongDetailDialog.create(song).show(activity.getSupportFragmentManager(), "SONG_DETAILS");
            ...
            case R.string.go_to_artist:
                ...
                return true;
            case R.string.delete_from_playlist1:
                RemoveFromPlaylistDialog.create(song).show(activity.getSupportFragmentManager(), "DELETE_PLAYLIST");
                return true;
