...
//            mBottomNavigationParent = activity.findViewById(R.id.bottom_navigation_parent);
            mBottomNavigationView = activity.findViewById(R.id.bottom_navigation_view);
...
//        } else
        if (mViewPager.getCurrentItem() != 0) {
            mViewPager.setCurrentItem(0, true);
                ...
                return mViewPager.getCurrentItem() != 0 || mNavigationAdapter.onBackPressed(0);
        }
        return true;
    }
...
//        Log.e("navigation","onPageSelected");
        LocalBroadcastManager lbm = LocalBroadcastManager.getInstance(getContext());
        Intent localIn = new Intent("player");
