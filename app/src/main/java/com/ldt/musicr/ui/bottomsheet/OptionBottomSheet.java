...
//        imageParams.topMargin = (int)(5*dp);
...
//        root.addView(imageView,imageParams);
        ...
        Params.bottomMargin = (int)(5*dp);
        Params.gravity = Gravity.LEFT;
        Params.topMargin = (int)(5*dp);
        Params.leftMargin= (int)(5*dp);
        title.setPadding((int)(12*dp),0,(int)(12*dp),0);
        title.setTextSize(TypedValue.COMPLEX_UNIT_SP, 20);
        title.setTypeface(Typeface.DEFAULT_BOLD);
        title.setTextColor(context.getResources().getColor(R.color.backward_color1));
        title.setGravity(Gravity.CENTER|Gravity.CENTER_HORIZONTAL);
        if(mObject instanceof Song) {
            Song song=(Song)mObject;
            title.setText(song.title);
//            Log.e("tag","Song" + song);
        } else if (mObject instanceof Playlist) {
            Playlist song = (Playlist) mObject;
            title.setText(song.name);
//            Log.e("tag","Playlist");
        }
        else if(mObject instanceof Artist) {
            Artist song = (Artist) mObject;
            title.setText(song.getName());
//            Log.e("tag","Artist");
        }
        else if(mObject instanceof Album) {
            Album song = (Album) mObject;
            title.setText(song.getTitle() + " - " +song.getArtistName() );
//            Log.e("tag","Artist");
        }
        ...
        for (int i = 0, optionsLength = options.length; i < optionsLength; i++) {
            if(options[i]==R.string.divider) {
                ...
                divider.setBackgroundColor(getActivity().getResources().getColor(R.color.NearlyWhite));
    ...
    public void onViewCreated(@NotNull View view, @Nullable Bundle savedInstanceState) {
        ...
        view.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                bottomSheet.setBackground(getActivity().getResources().getDrawable(R.drawable.bottom_bg_card));
