...
import com.ldt.musicr.ui.page.favouritePage.FavouriteFragment;
...
public class BottomNavigationPagerAdapter extends FragmentPagerAdapter {
    ...
    private void initData() {
        ...
        mData.add(BackPressableFragment.newInstance(new FavouriteFragment()));
        mData.add(BackPressableFragment.newInstance(new SearchSongFragment()));
    ...
    public CharSequence getPageTitle(int position) {
        switch (position) {
            ...
            case 3: return mContext.getResources().getString(R.string.settings);
            default:return "";
        }
    }
}
