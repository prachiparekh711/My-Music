...
import com.ldt.musicr.ui.dialog.CreatePlaylistDialog;
...
import com.ldt.musicr.ui.page.subpages.singleplaylist.SinglePlaylistHeaderAdapter;
...
public class PlaylistChildTab extends MusicServiceFragment implements FeaturePlaylistAdapter.PlaylistClickListener  {
    ...
    private void refreshData() {
        if (getActivity() != null) {
            List<Playlist> data=PlaylistLoader.getAllPlaylistsWithAuto(getActivity());
