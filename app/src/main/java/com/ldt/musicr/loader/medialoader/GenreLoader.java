...
public class GenreLoader {
    ...
    public static Cursor getGenreCursorForAlbum(final Context context, long albumID) {
        String query = " _id in (select genre_id from audio_genres_map where audio_id in (select _id from audio_meta where " + SongLoader.BASE_SELECTION + " AND album_id = " + albumID + "))";
        final String[] projection = new String[]{
                Genres._ID,
                Genres.NAME
        };
